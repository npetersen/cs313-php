...
<head>
  ...
  <link href="css/home.custom.css" rel="stylesheet" type="text/css">

  <!-- Scripts -->
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
  <script src="js/home.min.js" type="text/javascript" name="main-scripts"></script>

  <!-- Custom Scripts -->
  <!--script src="js/home.custom.js" type="text/javascript" name="custom-scripts"></script-->
...
<body class="slides simplifiedMobile smoothScroll animated">
  ...
  <nav class="panel top forceMobileView">
    <div class="sections">
      <div class="left"></div>
      <div class="center"><a href="#home" title="Nate Petersen">Nate Petersen</a></div>
  ...
  <section name="home" class="slide fade kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap">
    ...
    <div class="background" style="background-image:url(images/bg-home.jpg)"></div>
  </section>

  <section name="assignments" class="slide fade kenBurns">
    <div class="content">
      <div class="container">
        <div class="wrap">
  ...
  <section name="contact" class="slide fade kenBurns">
    ...
    <div class="background" style="background-image:url(images/bg-assignments.jpg)"></div>
  </section>
